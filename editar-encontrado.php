					...
					<div class="col-xs-12"><!--  col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 -->
						<div class="padding-30 bg-fff">
							<form action="" method="POST" enctype="multipart/form-data" id="formEditarAnuncio">
								<h1 class="font-700 mbottom-30 mtop-0 text-uppercase text-center font-1-3em color-blue">Editar anúncio de animal encontrado</h1>
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6">
										...
										<div class="form-group">
											<div class="list-group segmented-control">
								                ...
								                <a href="#" class="list-group-item">
								                    Não
								                    <input type="radio" name="resgatado" value="false"/>
								                </a>
								            </div>
										</div>
									</div>
			...
			function getAnunciosDoacao() {
				$.ajax({
					...
					success:function(x){
						...
						if (x.animal.resgatado == true) {
							$('#formEditarAnuncio input[name="resgatado"][value="true"]').trigger('click');
						} else if (x.animal.resgatado == false) {
							$('#formEditarAnuncio input[name="resgatado"][value="false"]').trigger('click');
						}
						...
						for (i = 0; i < x.animal.imagens.length; i++) {
							...
							html += '<img src="http://31.220.53.123:8080/luckypets-servidor/api/file/encontrado/' + x.id + '/' + x.animal.imagens[i] + '" finalendereco="'+x.animal.imagens[i]+'" class="img-responsive">';

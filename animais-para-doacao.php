								...
								<div class="bg-fff padding-30">
									<div class="row padver-50">
										<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
											...
											<p class="font-1-2em text-center font-300 mbottom-0">Parece que a sua busca não retornou nenhum resultado para <?= $_SESSION["cidade"]; ?> - <?= $_SESSION["estado"]; ?>.<br>Mude os filtros e tente novamente ou desative o filtro por cidade e estado <a href="animais-para-doacao.php?desativarFiltro=1" class="font-700">clicando aqui</a>.</p>
										</div>
									</div>
								</div>
							</div>

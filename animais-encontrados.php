	...
	<body>
				...
				<div class="col-xs-12 padhor-0">
					...
					<div class="force-vertical-align black-bg-filter width-100per">
						<div class="force-vertical-align">
							<h1 class="text-center font-1-8em text-uppercase font-700 color-fff mtop-0 mbottom-5 text-shadow font-1-3em-xs mbottom-30-xs">Cachorros e gatos encontrados</h1>
							<p class="mbottom-30 text-center font-300 font-1-5em color-fff text-shadow hidden-xs">Veja a lista de todos os animais encontrados</p>
						</div>
					</div>
				</div>
			</div>
		...
		<script>
			$(function(){
				...
				$urlGetEncontrados = 'http://31.220.53.123:8080/luckypets-servidor/api/anuncio/get-encontrados-cidade'.$cidadeestado;
				...
				$.ajax({
				    ...
				    success:function(x){
					    ...
					    for (i = 0; i < x.length; i++) {
							...
							html += '			<p class="mbottom-0 text-center">';

			...
			<div class="row">
				<div class="col-xs-12 padhor-0">
					...
					<div class="force-vertical-align width-100per">
						<h1 class="text-center font-1-8em text-uppercase font-700 color-fff mtop-0 mbottom-5 text-shadow font-1-3em-xs mbottom-30-xs">Animais perdidos</h1>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-xs-12"><!--  col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 -->
						<div class="padding-30 bg-fff">
							<h1 class="font-700 mbottom-30 mtop-0 text-uppercase text-center font-1-3em color-blue">Lista de Animais Perdidos</h1>
			    ...
			    success:function(x){
				    ...
				    for (i = 0; i < x.length; i++) {
			    		html += '<tr>';
							...
							html += '<td><img src="http://31.220.53.123:8080/luckypets-servidor/api/file/perdido/' + x[i].id + '/' + x[i].animal.imagens[0] + '" class="img-responsive" style="max-height: 90px;"></td>';
					...
					$(this).on("click", function(){
						...
						if (confirmacao == true) {
							$.ajax({
							    type: 'GET',
							    crossOrigin: true,
							    url:'http://31.220.53.123:8080/luckypets-servidor/api/anuncio/delete-perdido/' + id,
								headers: {
									'Authorization': '<?php echo $_SESSION['basicAuth']; ?>'
								},
							    success:function(){
